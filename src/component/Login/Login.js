        ...
        <div className='row login-bg'>
            <div className="col-lg-5 bg-light p-5 mx-5 rounded text-dark" style={{ marginTop: "150px", marginBottom: "150px" }}>
                ...
                <Form onSubmit={handleLoginSubmit} className=" mb-3">
                    <input type="Email" name="email" onChange={handleOnChange} className="form-control mb-3" placeholder="Email" aria-label="Example text with button addon" aria-describedby="button-addon1" />

                    <input type="Password" name="password" onChange={handleOnChange} className="form-control mb-3" placeholder="Password" aria-label="Example text with button addon" aria-describedby="button-addon1" />
                    <br />
                    <button className="btn mb-4 border-0 text-light btn-grd" type="submit">Login</button>
                    <div>
