...
const Apartment = ({ apartment }) => {
    ...
    return (
        <div className="col-lg-4" style={{ backgroundColor: "#D6E5FA", width: "350px", marginRight: "20px", height: "330px", marginBottom: "30px", borderRadius: "10px" }}>
            <div className='position-relative mt-3 '>
                ...
                <div className='overlay d-flex align-items-center justify-content-between'>
                    <h className='text '>ADD TO CART </h>
            ...
            <div className='d-flex justify-content-around'>
                <div className='d-flex align-items-center '>
                    <p> <i class="fas fa-bed"></i> {bads}Beds</p>
                </div>
                <div className='d-flex align-items-center'>
